    ...
    <div class="navbar" style="background-color: #FEFAE0;">
        ...
        <div class="flex-1 justify-center">
            <ul class="menu menu-horizontal rounded-box"
                style="background-color: #FEFAE0; color: #5F6F52; font-weight: 300; font-family: Poppins, sans-serif; font-size: 15px;">
                <li>
                    <a href="{{ url('/admins') }}">
          ...
          <div class="card-actions">
            ...
            <div class="dropdown dropdown-end">
                ...
                <ul tabindex="0"
                    ...
                    <li><a style="color: #5F6F52; font-family: Poppins, sans-serif; font weight: 300;">Settings</a></li>
