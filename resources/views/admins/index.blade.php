...
@section('content')
    ...
    <h1 class="display-3 fw-bolder mb-6" style="text-align: center; font-family: 'Alfa Slab One', serif; color: #5F6F52;">
        Admin Management</h2>
        <button id="createAdmin" class="btn d-flex justify-content-center align-items-center"
