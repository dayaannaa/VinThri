                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number" class="form-control quantity-input" value="${cart.quantity}" min="1">
                                            <button class="btn btn-outline-secondary btn-plus" type="button">+</button>
                                        </div>
                                        <button class="btn btn-sm btn-danger delete-item" data-cart-id="${cart.cart_id}">Delete</button>
                                    </div>
                                </div>
                            </div>
                        </div>
